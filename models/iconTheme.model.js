...
// Define the schema for the 'icon theme' model
const iconThemeSchema = new Schema(
  {
    // Define the "title" field for storing the icon theme title
    title: {
      type: String, // Data type: String
      required: true, // Validation: Title is required
    },
    // Define the "description" field for storing the icon theme description
    description: {
      type: String, // Data type: String
    ...
    // Define the "category" field for storing the icon theme category
    category: {
      type: String, // Data type: String
    ...
    // Define the "tags" field for storing an array of tags associated with the icon theme
    tags: [{ 
      type: String, // Data type: String
      maxlength: 100,
...
module.exports = model('IconTheme', iconThemeSchema);